...
Система саморазмышлений LLM: при получении задачи раскручивает её до начала повторов или до остановки. Работа с LM Studio и OpenRouter.ai.
...
- `app/llm.py` — вызов LLM API (LM Studio / OpenRouter), саморазмышление, ответ пользователю
